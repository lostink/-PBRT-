...
public:
    ...
    virtual Color3f Li(const Ray& ray, const Scene& scene, std::shared_ptr<Sampler> sampler, int depth, Color3f accum) const = 0;
...
protected:
    ...
    Camera * const camera;			// A pointer to the Camera instance stored in MyGL.
